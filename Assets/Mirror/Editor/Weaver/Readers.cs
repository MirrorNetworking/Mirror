...
namespace Mirror.Weaver
{
    ...
    {
        /// <summary>
        /// Checks if GeneratedNetworkCode exist, if it does not exist it creates one
        /// <para>GeneratedNetworkCode holds Read/Write functions generated by weaver</para>
        /// </summary>
        public static void ConfirmGeneratedCodeClass()
        {
            ...
            Weaver.WeaveLists.generateContainerClass = new TypeDefinition("Mirror", "GeneratedNetworkCode",
            ...
            method.Body.Instructions.Add(Instruction.Create(OpCodes.Call, Resolvers.ResolveMethod(WeaverTypes.objectType, Weaver.CurrentAssembly, ".ctor")));
            method.Body.Instructions.Add(Instruction.Create(OpCodes.Ret));

            Weaver.WeaveLists.generateContainerClass.Methods.Add(method);
        }
    }
