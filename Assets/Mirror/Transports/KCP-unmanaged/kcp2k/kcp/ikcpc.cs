...
namespace KCP
{
    ...
    {
        private static void memcpy(void* dest, void* src, int n) => Buffer.MemoryCopy(src, dest, n, n);

        private static void memcpy(void* dest, void* src, uint n) => Buffer.MemoryCopy(src, dest, n, n);
