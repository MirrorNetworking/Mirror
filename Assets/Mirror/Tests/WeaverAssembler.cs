...
{
    public const string kOutputDirectory = "Assets/Mirror/Tests/WeaverTests~/";
    ...
    public static void AddSourceFiles(string[] sourceFiles)
    {
        ...
        {
            SourceFiles.Add(kOutputDirectory + src);
        }
    }
    ...
    public static void DeleteOutput()
    {
        ...
        string projPathFile = kOutputDirectory + OutputFile;
    ...
    {
        AssemblyBuilder assemblyBuilder = new AssemblyBuilder(kOutputDirectory + OutputFile, SourceFiles.ToArray());
