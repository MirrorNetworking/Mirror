...
namespace Mirror.Tests
{
    ...
    public class MessageBaseTests
    {
        ...
        [Test]
        public void WovenSerializationWithExclusion()
        {
            NetworkWriter w = new NetworkWriter();
            WovenTestMessageWithExclusion msg = new WovenTestMessageWithExclusion
            {
                IntValue = 1,
                StringValue = "2",
                DoubleValue = 3.3
            ...
            Assert.AreNotEqual(msg.IntValue, t.IntValue);
            Assert.AreEqual(default(int), t.IntValue);

            Assert.AreNotEqual(msg.StringValue, t.StringValue);
