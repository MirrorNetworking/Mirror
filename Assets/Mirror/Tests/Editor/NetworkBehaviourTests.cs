...
namespace Mirror.Tests
{
    ...
    {
        public bool SyncVarGameObjectEqualExposed(GameObject newGameObject, ushort netId)
        {
            return SyncVarGameObjectEqual(newGameObject, netId);
        }
    }

    class SyncVarNetworkIdentityEqualExposedBehaviour : NetworkBehaviour
    {
        public bool SyncVarNetworkIdentityEqualExposed(NetworkIdentity newNetworkIdentity, ushort netId)
        {
            return SyncVarNetworkIdentityEqual(newNetworkIdentity, netId);
        }
    }
