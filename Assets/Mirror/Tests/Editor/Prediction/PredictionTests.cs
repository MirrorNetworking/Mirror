...
namespace Mirror.Tests
{
    public class PredictionTests
    {
        ...
        public void Sample_Empty()
        {
            ...
            Assert.That(Prediction.Sample(history, 0.5, out int before, out int after, out double t), Is.False);
        }
        ...
        public void Sample_BeforeOldest()
        {
            ...
            Assert.That(Prediction.Sample(history, -1, out int before, out int after, out double t), Is.False);
        }
        ...
        public void Sample_AfterNewest()
        {
            ...
            Assert.That(Prediction.Sample(history, 3, out int before, out int after, out double t), Is.False);
        }
        ...
        public void Sample_MultipleEntries()
        {
            ...
            Assert.That(Prediction.Sample(history, 0.0, out int before, out int after, out double t), Is.True);
            Assert.That(before, Is.EqualTo(0));
            Assert.That(after, Is.EqualTo(0));
            Assert.That(t, Is.EqualTo(0.0));

            // sample at 0.5
            Assert.That(Prediction.Sample(history, 0.5, out before, out after, out t), Is.True);
            Assert.That(before, Is.EqualTo(0));
            Assert.That(after, Is.EqualTo(1));
            Assert.That(t, Is.EqualTo(0.5));

            // sample at 1.5
            Assert.That(Prediction.Sample(history, 1.5, out before, out after, out t), Is.True);
            ...
            Assert.That(Prediction.Sample(history, 2.0, out before, out after, out t), Is.True);
