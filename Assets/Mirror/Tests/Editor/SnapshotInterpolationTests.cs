...
namespace Mirror.Tests
{
    ...
    public class SnapshotInterpolationTests
    {
        ...
        public void InsertTwice()
        {
            ...
            // insert twice
            SnapshotInterpolation.InsertAndAdjust(buffer, snap, ref localTimeline, ref localTimescale, 0, 0, 1, 0.01, 0.01, ref driftEma, 0, 0, ref deliveryIntervalEma);
            SnapshotInterpolation.InsertAndAdjust(buffer, snap, ref localTimeline, ref localTimescale, 0, 0, 1, 0.01, 0.01, ref driftEma, 0, 0, ref deliveryIntervalEma);
        ...
        public void Insert_Sorts()
        {
            ...
            SnapshotInterpolation.InsertAndAdjust(buffer, b, ref localTimeline, ref localTimescale, 0, 0, 1, 0.01, 0.01, ref driftEma, 0, 0, ref deliveryIntervalEma);
            SnapshotInterpolation.InsertAndAdjust(buffer, a, ref localTimeline, ref localTimescale, 0, 0, 1, 0.01, 0.01, ref driftEma, 0, 0, ref deliveryIntervalEma);
        ...
        public void Insert_ComputesAverageDrift()
        {
            ...
            SnapshotInterpolation.InsertAndAdjust(buffer, a, ref localTimeline, ref localTimescale, 0, 0, 1, 0.01, 0.01, ref driftEma, 0, 0, ref deliveryIntervalEma);
            SnapshotInterpolation.InsertAndAdjust(buffer, b, ref localTimeline, ref localTimescale, 0, 0, 1, 0.01, 0.01, ref driftEma, 0, 0, ref deliveryIntervalEma);
            SnapshotInterpolation.InsertAndAdjust(buffer, c, ref localTimeline, ref localTimescale, 0, 0, 1, 0.01, 0.01, ref driftEma, 0, 0, ref deliveryIntervalEma);
