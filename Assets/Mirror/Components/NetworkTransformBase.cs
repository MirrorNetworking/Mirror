...
namespace Mirror
{
    public abstract class NetworkTransformBase : NetworkBehaviour
    {
        ...
        [SerializeField] RotationCompression compressRotation = RotationCompression.Much;
        ...
        public static void SerializeIntoWriter(NetworkWriter writer, Vector3 position, Quaternion rotation, RotationCompression compressRotation, Vector3 scale)
        {
            // serialize position
            writer.WriteVector3(position);

            // serialize rotation
            writer.WriteRotation(rotation, compressRotation);
        ...
        void DeserializeFromReader(NetworkReader reader)
        {
            ...
            temp.localRotation = reader.ReadRotation(compressRotation);
        ...
        void ApplyPositionRotationScale(Vector3 position, Quaternion rotation, Vector3 scale)
        {
            ...
            if (RotationCompression.NoRotation != compressRotation)
            {
