...
{
    public class TankControllerUI : MonoBehaviour
    {
        [Serializable]
        ...
        public void Refresh(MoveKeys moveKeys, OtherKeys otherKeys, OptionsKeys optionsKeys)
        {
            // Movement Keys
            ...
            // Options Keys
            optionsTexts.keyTextMouseLock.text = GetKeyText(optionsKeys.MouseLock);
