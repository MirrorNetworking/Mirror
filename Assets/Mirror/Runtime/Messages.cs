...
namespace Mirror
{
    // NetworkMessages should always be structs to avoid allocations, so we use
    // an interface.
    ...
    //[Obsolete("IMessageBase was renamed to NetworkMessage for ease of use.")]
    public interface IMessageBase : NetworkMessage {}
