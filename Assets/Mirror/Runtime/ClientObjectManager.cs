...
namespace Mirror
{
    ...
    /// <summary>
    /// Provides Object Management to a NetworkServer and or NetworkClient.
    /// <para>The <see cref="NetworkClient">NetworkClient</see> loads objects as instructed by the <see cref="NetworkServer">NetworkServer</see>.</para>
