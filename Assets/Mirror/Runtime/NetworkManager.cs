...
namespace Mirror
{
    ...
    public class NetworkManager : MonoBehaviour
    {
        ...
        public virtual void StartHost()
        {
            ...
            //               {
            //                   if (server.localClientActive && !getSyncVarHookGuard(1uL))
            //                   {
            ...
            NetworkClient.ConnectHost(server);
        ...
        void FinishLoadScene()
        {
            ...
            // host mode?
            if (NetworkClient.active && server.active)
            {
                FinishLoadSceneHost();
            }
            // server-only mode?
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        void OnClientSceneInternal(NetworkConnection conn, SceneMessage msg)
        {
            ...
            if (NetworkClient.isConnected && !server.active)
            {
