...
namespace Mirror
{
    ...
    public static class NetworkDiagnostics
    {
        ...
        internal static void OnSend<T>(T message, int channel, int bytes, int count) where T : INetworkMessage
        {
        ...
        internal static void OnReceive<T>(T message, int channel, int bytes) where T : INetworkMessage
        {
