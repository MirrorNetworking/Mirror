...
namespace Mirror
{
    public static class ClientScene
    {
        ...
        public static Dictionary<NetworkGuid, GameObject> prefabs = new Dictionary<NetworkGuid, GameObject>();
        // scene id to NetworkIdentity
        public static Dictionary<uint, NetworkIdentity> spawnableObjects;

        // spawn handlers
        internal static Dictionary<NetworkGuid, SpawnDelegate> spawnHandlers = new Dictionary<NetworkGuid, SpawnDelegate>();
        internal static Dictionary<NetworkGuid, UnSpawnDelegate> unspawnHandlers = new Dictionary<NetworkGuid, UnSpawnDelegate>();
        ...
        internal static bool GetPrefab(NetworkGuid assetId, out GameObject prefab)
        {
            prefab = null;
            return assetId != NetworkGuid.Empty &&
        ...
        public static void RegisterPrefab(GameObject prefab, NetworkGuid newAssetId)
        {
        ...
        public static void RegisterPrefab(GameObject prefab, SpawnDelegate spawnHandler, UnSpawnDelegate unspawnHandler)
        {
            ...
            if (identity.assetId == NetworkGuid.Empty)
            {
        ...
        public static void RegisterSpawnHandler(NetworkGuid assetId, SpawnDelegate spawnHandler, UnSpawnDelegate unspawnHandler)
        {
            if (spawnHandler == null || unspawnHandler == null)
            {
        ...
        public static void UnregisterSpawnHandler(NetworkGuid assetId)
        {
        ...
        internal static bool InvokeUnSpawnHandler(NetworkGuid assetId, GameObject obj)
        {
        ...
        static void OnSpawnPrefab(NetworkMessage netMsg)
        {
            ...
            if (msg.assetId == NetworkGuid.Empty)
            {
