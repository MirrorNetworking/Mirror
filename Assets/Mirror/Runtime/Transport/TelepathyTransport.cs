...
namespace Mirror
{
    ...
    public class TelepathyTransport : Transport
    {
        ...
        [EditorBrowsable(EditorBrowsableState.Never), System.Obsolete("Use MaxMessageSizeFromClient or MaxMessageSizeFromServer instead.")]
        public int MaxMessageSize
        {
            get => MaxMessageSizeFromClient;
            set => MaxMessageSizeFromServer = MaxMessageSizeFromClient = value;
        }

        [Tooltip("Protect against allocation attacks by keeping the max message size small. Otherwise an attacker might send multiple fake packets with 2GB headers, causing the server to run out of memory after allocating multiple large packets.")]
        [FormerlySerializedAs("MaxMessageSize")] public int MaxMessageSizeFromClient = 16 * 1024;
        ...
        [FormerlySerializedAs("MaxMessageSize")] public int MaxMessageSizeFromServer = 16 * 1024;
        ...
        void Awake()
        {
            ...
            client.MaxMessageSize = MaxMessageSizeFromServer;
            server.NoDelay = NoDelay;
            server.MaxMessageSize = MaxMessageSizeFromClient;
