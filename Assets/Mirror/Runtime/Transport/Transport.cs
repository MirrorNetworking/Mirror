...
namespace Mirror
{
    ...
    public abstract class Transport : MonoBehaviour
    {
        ...
        /// clients at once more efficiently if needed. E.g. UDP multicast.
        /// </summary>
        /// <param name="connectionIds">The list of client connection ids to send data to.</param>
        /// <param name="channelId">The channel to be used.  Transports can use channels to implement
        /// other features such as unreliable, encryption, compression, etc...</param>
        /// <param name="data"></param>
        /// <returns>true if the data was sent to all connections</returns>
        public virtual bool ServerSend(IEnumerable<int> connectionIds, int channelId, byte[] data)
        {
