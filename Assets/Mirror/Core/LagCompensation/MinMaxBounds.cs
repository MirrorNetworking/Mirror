// Godot's Bounds struct is represented as (center, extents).
// HistoryBounds make heavy use of .Encapsulate(), which has to convert
// Godot's (center, extents) to (min, max) every time, and then convert back.
//
...
namespace Mirror
{
    public struct MinMaxBounds: IEquatable<Bounds>
    {
        ...
        // convenience comparison with Godot's bounds, for unit tests etc.
