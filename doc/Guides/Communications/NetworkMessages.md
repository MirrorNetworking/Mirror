...
Network Messages need to be structs in order to avoid runtime allocations, and they need to implement the NetworkMessage interface. This interface requires Serialize and Deserialize functions that take writer and reader objects. You can implement these functions yourself, but we recommend you let them empty and let Mirror generate them for you.
...
To send a message, use the `Send()` method on the NetworkClient, NetworkServer, and NetworkConnection classes which work the same way. It takes a message struct that implements NetworkMessage. The code below demonstrates how to send and handle a message:
...
public class Scores : MonoBehaviour
{
    public struct ScoreMessage : NetworkMessage
    {
        ...
        // Mirror auto generates serialization
        public virtual void Deserialize(NetworkReader reader) {}
        public virtual void Serialize(NetworkWriter writer) {}
    }
