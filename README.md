...
For the latest improvements, consider the [Mirror Download](https://github.com/vis2k/Mirror/releases) directly from this repository instead. Afterwards extract it in your project's Assets folder.
