...
namespace Mirror
{
    ...
    public class NetworkBehaviour : MonoBehaviour
    {
        ...
        protected void SendCommandInternal(string cmdName, NetworkWriter writer, int channelId)
        {
            ...
            message.cmdHash = (GetType() + ":" + cmdName).GetStableHashCode(); // type+cmd so Inventory.RpcUse != Equipment.RpcUse
        ...
        protected void SendRPCInternal(string rpcName, NetworkWriter writer, int channelId)
        {
            ...
            message.netId = netId;
            message.componentIndex = ComponentIndex;
            message.rpcHash = (GetType() + ":" + rpcName).GetStableHashCode();
            message.payload = writer.ToArray();
        ...
        protected void SendEventInternal(string eventName, NetworkWriter writer, int channelId)
        {
            ...
            message.netId = netId;
            message.componentIndex = ComponentIndex;
            message.eventHash = (GetType() + ":" + eventName).GetStableHashCode();
            message.payload = writer.ToArray();
        ...
        {
            int cmdHash = (invokeClass + ":" + cmdName).GetStableHashCode();
